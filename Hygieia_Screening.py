#This is a test version of Hygieia, which deletes files older than a specified number of days
# and will email a list of files older than a specified number of days to serve as a "warning".
# Deletion functions have been removed, this script just acts as a testing tool to ensure you won't
# delete anything important when you run the Hygieia script.
...
# Check to see if output.txt file already exists from previous run
...
# Change receiver_email to the email you want txt files sent to, do not change password
subject = "Hygieia Screening"
body = "The attached file 'warning.txt' indicates which files and folders are in between the warning and deletion interval.  \nThe 'deleted.txt' file indicates the files and folders that would be deleted when running the hygieia.py with the same parameters.  \nNo files have been deleted when running this script. \n\nThanks for coming to my TED talk."
	...
	if os.path.exists(path):
		...
		for root_folder, folders, files in os.walk(path):
			...
			if seconds >= get_file_or_folder_age(root_folder):
				...
				# adds to count of folders that would be removed
				# remove folder function would go here
			...
			for folder in folders:
				...
				if seconds >= get_file_or_folder_age(folder_path):
					...
					# adds to count of folders that would be deleted
					# remove folder function would go here
					deleted_folders_count += 1 
			...
			for file in files:
				...
				if seconds >= get_file_or_folder_age(file_path):
					...
					# adds to count of files that would be deleted
					# remove file function would go here
...
### NOTE: REMOVAL FUNCTIONS REMOVED IN TEST SCRIPT, SEE hygieia.py FOR FUNCTIONS 
